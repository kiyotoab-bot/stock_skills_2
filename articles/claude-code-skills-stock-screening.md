...
emoji: "📈"
type: "tech"
topics: ["ClaudeCode", "Python", "yfinance", "バイブコーディング", "株式投資"]
published: false
---
...
![Skills のディレクトリ構造](screenshot-01.png)
...
![個別レポート出力](screenshot-03.png)

ポートフォリオのスナップショット機能では、保有銘柄の現在評価額と損益を一覧できます。

![ポートフォリオスナップショット](screenshot-04.png)
...
![Linear Issue画面](screenshot-09.png)
